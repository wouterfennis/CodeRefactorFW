...
public class LoginSupportServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// If forgot username called.
			...
			this.ForgotUsername(req, resp, db);
		}

	}

	private void ForgotUsername(HttpServletRequest req, HttpServletResponse resp, DatabaseInterface db) throws ServletException, IOException {
		String message = "";
		User user = null;
